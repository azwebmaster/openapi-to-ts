...
# Swagger v2 Medium Sample Generation Script
# This script generates TypeScript client from the medium complexity Swagger v2 specification
...
SPEC_FILE="$SCRIPT_DIR/swagger-v2-medium.json"
