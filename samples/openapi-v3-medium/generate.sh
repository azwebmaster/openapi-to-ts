...
# OpenAPI v3 Medium Sample Generation Script
# This script generates TypeScript client from the medium complexity OpenAPI v3 specification
...
SPEC_FILE="$SCRIPT_DIR/openapi-v3-medium.yaml"
