 ...
 *
 * A medium complexity OpenAPI v3 specification with authentication, file uploads, and complex schemas
 */
export class APIClient {
     ...
     */
    public async uploadUserAvatar(params: UploadUserAvatarParams, data: { file: string; description?: string }, config?: AxiosRequestConfig): Promise<AxiosResponse<FileInfo>> {
        return this.client.post(`/users/${params.userId}/avatar`, data, config);
    }
