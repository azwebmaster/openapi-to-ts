@echo off
REM Swagger v2 Simple Sample Generation Script (Windows)
REM This script generates TypeScript client from the simple Swagger v2 specification
...
set SPEC_FILE=%SCRIPT_DIR%swagger-2.0-test.json
